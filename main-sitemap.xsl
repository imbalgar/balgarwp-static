			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Balgarian Portal | Reviews Donghua &amp; Teknologi</title>
					</xsl:when>
					<xsl:otherwise>
						<title>Peta Situs XML - Balgarian Portal | Reviews Donghua &amp; Teknologi</title>
					</xsl:otherwise>
				</xsl:choose>
					...
					<xsl:when test="kml:kml">
						...
						<div id="description">
							...
							<h1>File KML</h1>
															...
															<p>
									Berkas KML ini dihasilkan oleh <a href="https://rankmath.com/" target="_blank">Plugin WordPress Rank Math SEO</a>. Ini digunakan untuk memberikan informasi lokasi ke Google.								</p>
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://https://balgarwp-static.pages.dev/sitemap_index.xml">&#8592; Index Peta Situs</a>							</p>
					...
					<xsl:otherwise>
						...
						<div id="description">
							...
							<h1>Peta Situs XML</h1>
															...
															<p>
									Peta Situs XML ini dibuat oleh <a href="https://rankmath.com/" target="_blank">Plugin WordPress Rank Math SEO</a>. Inilah yang digunakan oleh mesin pencari seperti Google untuk merayapi dan merayapi kembali posting/halaman/produk/gambar/arsip di situs web Anda.								</p>
